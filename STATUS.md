...
## Current task
T-002 starting — read CLAUDE.md + v3 patch end-to-end, write build understanding to DECISIONS.md.
...
- [ ] T-002 — Read CLAUDE.md + v3 patch, write summary to DECISIONS.md
...
- [ ] T-007 — Mind agent system prompt `requires_safety_review` `requires_lev_input`
- [ ] T-008 — Body agent system prompt `requires_safety_review` `requires_lev_input`
- [ ] 🛑 GATE 1

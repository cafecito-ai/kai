  ...
  return (
    <AppPage className="max-w-3xl">
      ...
      <AppSurface className="p-4 sm:p-6">
        ...
        <p className="mt-2 leading-7 text-muted">Under-13 onboarding includes a parental consent path. Severe safety categories are logged for operations review and can trigger parent-notification workflows when configured.</p>
      </AppSurface>
    </AppPage>
  );
}

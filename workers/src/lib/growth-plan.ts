...
function mentionsDating(text: string) {
  return (
    /\b(girlfriend|gf|girl friend|boyfriend|bf|relationship|date|dating|get a girl|get girls|pull girls|talk to girls|ask (a )?(girl|boy|someone|her|him|them) out|crush)\b/.test(text) &&
